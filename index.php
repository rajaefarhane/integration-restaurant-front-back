...
<div class="container">
  ...
  <div class="row ligne2" >
    <div class="col-lg-4">
      <img src="img/suts9k7v.png" alt="image1" class="img11">
      <div class="texteimg">
        <h3 class="ham">Ham Sandwich</h3>
        <h3 class="prix">$10.50</h3>
        <?php
    ...
    <div class="col-lg-4">
      <img src="img/p9eh9haz.png" alt="image1" class="img11">
      <div class="texteimg">
        <h3 class="ham">Ham Sandwich</h3>
        <h3 class="prix">$10.50</h3>
        <?php
    ...
    <div class="col-lg-4">
      <img src="img/aiu45f8t.png" alt="image1" class="img11">
      <div class="texteimg">
        <h3 class="ham">Ham Sandwich</h3>
        <h3 class="prix">$10.50</h3>
        <?php
